...
class Soc(gvsoc.systree.Component):
    ...
    def __init__(self, parent, name, parser):
        ...
        # Main memory
        mem = memory.memory.Memory(self, 'mem', size=0x20000000)
        ...
        ico.o_MAP(mem.i_INPUT(), 'mem', base=0x00000000, size=0x20000000, rm_base=True)
        mem.add_properties({
            "background": {
                "dynamic": {
                    "type": "linear",
        ...
        ico.o_MAP(mem2.i_INPUT(), 'mem2', base=0x20000000, size=0x00100000, rm_base=True)
