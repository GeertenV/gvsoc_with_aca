...
class Soc(gvsoc.systree.Component):
    ...
    def __init__(self, parent, name, parser):
        ...
        # Main memory
        mem = memory.memory.Memory(self, 'mem', size=0x40000000)
        ...
        ico.o_MAP(mem.i_INPUT(), 'mem', base=0x00000000, size=0x10000000, rm_base=True)

        scratchpad = basic_scratchpad.BasicScratchpad(self, 'basic_scratchpad', latency=0x00005000, row_count=5, col_count=5)
        ico.add_mapping('basic_scratchpad', base=0x20000000, remove_offset=0x20000000, size=0x20000000)
        self.bind(ico, 'basic_scratchpad', scratchpad, 'input')
